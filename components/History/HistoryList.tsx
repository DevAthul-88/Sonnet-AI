...
import { Lock, MoreVertical, Pencil, Search, Trash, Loader2, Trash2, ArchiveIcon } from "lucide-react"
  ...
  const handleConfirmArchive = async () => {
    ...
    try {
      const response = await fetch(`/api/chats/${chatId}/archive`, {
        method: 'POST', // Use POST or PUT based on your API implementation
      });
